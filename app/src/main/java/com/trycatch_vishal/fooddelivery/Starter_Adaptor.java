...
public class Starter_Adaptor extends RecyclerView.Adapter<Starter_Adaptor.ViewHolder> {
    Context context;
    ArrayList<POJOSTATERS> pojostater;

    public Starter_Adaptor(Context context, ArrayList<POJOSTATERS> pojostater) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        //   POJOSTATERS item = pojostater.get(position);
